...
if setclipboard then
    setclipboard("https://discord.gg/egnmCcPS6T")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Link Copied!",
        Text = "The Discord link was copied in the clipboard.",
        Duration = 5
    })
else
    game.StarterGui:SetCore("SendNotification", {
        Title = "Error",
        Text = "We can't put the Discord link in the clipboard (setclipboard don't support your executor).",
        Duration = 5
    })
end
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingSubtitle = "by Zyrnox and Paranoia",
   ...
   Discord = {
      ...
      Invite = "nvvVbgTjcf", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
   ...
   KeySettings = {
      ...
      Note = "key is in https://discord.gg/egnmCcPS6T", -- Use this to tell the user how to get a key
      ...
      Key = {"https://raw.githubusercontent.com/zyrn0x/SillyKey/refs/heads/main/Key"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
