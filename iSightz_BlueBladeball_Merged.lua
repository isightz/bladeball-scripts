...
-- iSightz Bladeball Script (Merged UI + Combat Auto-Parry)
-- DO NOT ADD BLOCK COMMENTS IN EXECUTOR, THIS IS PURE LUA CODE
...
ScreenGui.Name = "iSightzBladeballScript"
...
Title.Text = "iSightz Bladeball Script"
Title.TextColor3 = Color3.fromRGB(150, 200, 255)
Title.Font = Enum.Font.GothamBold
Title.TextSize = 24
Title.Parent = MainFrame

-->> TOGGLE UI WITH RIGHT ALT <<--
